...
- [Если не устанавливаются пакеты через yarn](#0--eсли-не-устанавливаются-пакеты-через-yarn)
- [Создать необходимые файлы и папки](#)
- [Установить jest и babel](#)
- [Установить eslint](#yстановить-eslint)
